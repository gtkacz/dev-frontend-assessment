<template>
  <div id="app-layout" class="app">
    <div class="primary-layout-con">
      <div class="primary-menu-con">
        <div class="menu-items">
          <div class="logo-con">
            <img src="../assets/image/logo.png" class="image" alt="Logo" />
          </div>
          <router-link
            :to="{ name: $ROUTES.HOME }"
            exact
          ...
          <a
            href="https://github.com/gtkacz/dev-frontend-assessment"
            target="_blank"
            class="item tooltip is-tooltip-right"
      ...
      <div class="primary-content-con" style="height: 100%">
...
.primary-layout-con {
  ...
  & > .primary-menu-con {
    ...
    .logo-con {
      margin-left: $menuWidth * 0.1;
      margin-top: $menuWidth * 0.1;
      margin-bottom: 1em;
